...
![[Screenshot from 2023-07-11 00-05-57.png]]

- we can also add separators in order for a better view `'foo'||`~`||'bar'`
...
>[!Note]
>In the below queries we can observe that we have to specify the name in oracle where as in Microsoft and others we are not specifying anything
