...
```shell-session
premjampuram@htb[/htb]$ echo ${PATH}
...
```shell-session
premjampuram@htb[/htb]$ echo ${PATH:0:1}
...
```shell-session
premjampuram@htb[/htb]$ echo ${LS_COLORS:10:1}
...
```shell-session
premjampuram@htb[/htb]$ man ascii     # \ is on 92, before it is [ on 91
premjampuram@htb[/htb]$ echo $(tr '!-}' '"-~'<<<[)
