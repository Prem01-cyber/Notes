...
###### `Created on :- 2023-08-09 - 19:54`
###### `Created by:- Prem J`
***

- Vulnerabilities related to companies architecture i.e it isn't a bad implementation or configuration but the idea behind the whole implementation or a part of it.
...
- Sometimes shortcuts could also lead to insecure designs
